    ...
    1: [function (require, module, exports) {
        ...
        var Synapse = (function () {
            ...
            Synapse.prototype.findServers = function (maxInParallel, timeout, addServersInProgress, addServersInFinish, addServersInFail, ipMin, ipMax, typeB, ip) {
                ...
                {
                var ipWS = ipBase[0] + "." + ipBase[1] + "." + typeB + ".";
                 }   
                function tryIp(ip) {
                    ++numInParallel;
                    ...
                    var timer = setTimeout(function () {
                        ...
                        socket = null;
                        s.close();
                        if (addServersInFail != null &&
                            addServersInFail != undefined &&
                            typeof addServersInFail === "function") {
                            addServersInFail(s.url);
                        }
                        --numInParallel;
                        next();
                    }, timeout);
